...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT c.car_name, b.rent_start_date, b.rent_end_date, b.fare, b.charge_type, b.id FROM booking b, cars c
    WHERE b.customer_username='$login_customer' AND c.car_id=b.car_id AND b.return_status='NR'";
