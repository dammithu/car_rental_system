...
// Retrieve client username from session
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
        $query = "INSERT INTO cars (car_name, car_nameplate, car_img, ac_price, non_ac_price, ac_price_per_day, non_ac_price_per_day, car_availability, client_username) 
                  VALUES ('$car_name', '$car_nameplate', '$target_path', '$ac_price', '$non_ac_price', '$ac_price_per_day', '$non_ac_price_per_day', '$car_availability', '$client_username')";
