...
$username_query = "SELECT * FROM users WHERE username='" . $customer_username . "'";
...
$email_query = "SELECT * FROM users WHERE email='" . $customer_email . "'";
...
$query = "INSERT into users(username,name,email,phone,address,password,role) VALUES('" . $customer_username . "','" . $customer_name . "','" . $customer_email . "','" . $customer_phone . "','" . $customer_address ."','" . $customer_password ."','" . $role ."')";
