                        ...
                        <table class="table table-bordered text-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="adminedit.php?username=<?php echo $row['client_username']; ?>" class="btn btn-primary">Edit</a></td>
                                    <td><a href="deleteclient.php?username=<?php echo $row['client_username']; ?>" class="btn btn-danger">Delete</a></td>
                                </tr>
                            <?php
                            }
                            ?>
