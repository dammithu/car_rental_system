            ...
            <div class="col">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="display-6 text-center">CLIENT CAR DETAILES</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="deleteclientcars.php?id=<?php echo $row['car_id']; ?>" class="btn btn-danger">Delete</a></td>
                                </tr>
                            <?php
                            }
                            ?>
