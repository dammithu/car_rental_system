                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            <tr class="bg-dark text-white">
                                <td bgcolor="black">Admin username</td>
                                <td bgcolor="black">Password</td>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="admineditform.php?username=<?php echo $row['username']; ?>" class="btn btn-primary">Edit</a></td>
