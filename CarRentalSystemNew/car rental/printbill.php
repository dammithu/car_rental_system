...
$sql0 = "SELECT rc.id, rc.rent_end_date, rc.charge_type, rc.rent_start_date, c.car_name, c.car_nameplate FROM booking rc, cars c WHERE id = '$id' AND c.car_id = rc.car_id";
...
if($charge_type == "days"){
    ...
    $sql1 = "UPDATE booking SET car_return_date='$car_return_date', no_of_days='$no_of_days', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
} else {
    $distance = $distance_or_days;
    $sql1 = "UPDATE booking SET car_return_date='$car_return_date', distance='$distance', no_of_days='$duration', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
}

$result1 = $conn->query($sql1);

if ($result1){
     $sql2 = "UPDATE cars c, booking rc SET c.car_availability='yes'
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/bookingconfirm.css">
</head>
<body>
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
...
<div class="container">
    ...
    <div class="box">
        ...
        <div class="col-md-10 text-center" style="margin: 0 auto;">
            <!-- Payment button -->
            <form action="payment_procces1.php" method="post">
