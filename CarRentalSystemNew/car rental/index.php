    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="entercar.php">Add Cars</a></li>
              <li> <a href="mycars.php">My Cars</a></li>
              <li> <a href="clientview.php">View booked cars</a></li>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                        <li> <a href="adminclients1.php">clients</a></li>
                                        <li> <a href="admincustomer1.php">Customers</a></li>
                                        <li> <a href="admincar1.php">Car List</a></li>
                                        
                                        <li> <a href="rentedcars.php">Rented Cars</a></li>
                                        <li> <a href="adminacc.php">Admin account setting</a></li>
                                        <li> <a href="myfeedback.php">my Feedbacks</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black"> DCS Car Rentals</h1>
                            <p class="intro-text">
